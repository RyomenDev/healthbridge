...
const PatientForm = ({ selectedPatient, onPatientSave, onCancel }) => {
  ...
  return (
    <form
      ...
      className="space-y-8 max-w-3xl mx-auto p-8 bg-white rounded-lg shadow-xl transition-all duration-300"
    >
        ...
        <div className="form-group" key={field.name}>
          ...
          {field.type === "select" ? (
            <select
              ...
              className="input-field w-full px-4 py-2 mt-1 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
      ...
      <div className="flex space-x-4 justify-between mt-6">
        <button
          type="submit"
          className="submit-button w-1/2 py-3 px-6 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 transition-all duration-200"
        >
        ...
        <button
          type="button"
          onClick={onCancel}
          className="cancel-button w-1/2 py-3 px-6 bg-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-400 transition-all duration-200"
        >
          Cancel
        </button>
      </div>
